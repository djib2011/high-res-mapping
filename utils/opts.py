...
parser.add_argument('--results_name', type=str, default=None, help='name of the directory storing the results')
...
if opt.weight_dir and not os.path.exists(opt.weight_dir):
